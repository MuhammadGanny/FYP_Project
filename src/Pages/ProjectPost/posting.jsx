        ...
        <div>
            ...
            <Card className="w-[60%] ml-[20%]">
                <CardBody className="flex flex-col gap-4">
                    <Typography variant="h3" className="mb-4 grid h-28 place-items-center" >
                    Post Ideas
                    </Typography>
                    ...
                    onChange={(e) => setProjectHeading(e.target.value)}  
                     className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2  focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    <label className="block text-sm  font-bold leading-6 text-gray-900">
                        PROJECT DISCRIPTION
                    </label>
