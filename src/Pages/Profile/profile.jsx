  ...
  useEffect(() => {
    ...
    axios
      .get(
        ...
        {
          // params: {
          //   userId: "65a6269051958e965e442e47",
          //   userType: "student",
          // },
          headers: {
      ...
      .then((response) => {
        ...
        console.log("ye data set howa hai", userProfile);
      })
      .catch((error) => {
        ...
        <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="flex items-center">
              <div className="rounded-full overflow-hidden">
                <img
                  ...
                  src={userProfile.updatedProfile.profilePicture}
                  alt="Profile Picture"
                />
              </div>
              <div className="ml-4">
                <h1 className="text-xl font-bold text-gray-800">
                  {userProfile.updatedProfile.name}
                </h1>
                <p className="text-gray-500">
                  {userProfile.updatedProfile.university}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200">
            <div className="p-6">
              ...
              <p className="text-gray-600">{userProfile.updatedProfile.bio}</p>
            </div>
...
//               <div className="ml-7">
//                 <h1 className="text-xl font-bold text-gray-800">
//                   {userProfile.name} Ganny
//                 </h1>
//                 <p className="text-gray-500">
//                   {userProfile.university} Szabist
//                 </p>
//               </div>
//             </div>
//             {/* </div> */}
...
//                   {editedFields.bio || userProfile.bio}
//                 </p>
//               )}
//             </div>
...
//                   onChange={(e) =>
//                     handleInputChange("experiences", e.target.value)
//                   }
//                   className="w-full rounded-md border-1 py-2 pl-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
//                 />
//               ) : (
//                 <p className="text-gray-600">
//                   {editedFields.experiences || userProfile.experiences}
//                 </p>
//               )}
//             </div>
...
//               ) : (
//                 <p className="text-gray-600">
//                   {editedFields.education || userProfile.education}
//                 </p>
//               )}
//             </div>
