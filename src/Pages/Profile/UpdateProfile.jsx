...
//       console.log("Token retrieved:", tokenFromCookie);
//     }
//   }, []);
...
//         "updatedProfileData",
//         JSON.stringify(
//           userType === "student" ? studentProfileData : companyProfileData
//         )
//       );

//       if (userType === "student" && studentProfileData.profilePicture) {
//         formData.append("profilePicture", studentProfileData.profilePicture);
//       } else if (userType === "company" && companyProfileData.profilePicture) {
//         formData.append("profilePicture", companyProfileData.profilePicture);
//       }

//       await axios.put("http://localhost:5000/update-profile", formData, {
//         headers: {
//           Authorization: `Bearer ${token}`,
