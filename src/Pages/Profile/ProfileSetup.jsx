              ...
              <div>
                ...
                <label className="block mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setProfileData({ ...profileData, projects: e.target.value.split(',').map(s => s.trim()) })}
                    className="w-full border border-gray-300 rounded p-2 mb-2"
                  />
                </label>
                <label className="block mb-2">
                ...
                <label className="block mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setProfileData({ ...profileData, experiences: e.target.value.split(',').map(s => s.trim()) })}
                    className="w-full border border-gray-300 rounded p-2 mb-2"
                  />
                </label>
                <label className="block mb-2">
              ...
              <div>
                ...
                <label className="block mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setProfileData({ ...profileData, products: e.target.value.split(',').map(s => s.trim()) })}
                    className="w-full border border-gray-300 rounded p-2 mb-2"
                  />
                </label>
                <label className="block mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setProfileData({ ...profileData, services: e.target.value.split(',').map(s => s.trim()) })}
                    className="w-full border border-gray-300 rounded p-2 mb-2"
                  />
                </label>
              </div>
