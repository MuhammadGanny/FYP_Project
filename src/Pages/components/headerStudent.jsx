                  ...
                  <Menu as="div" className="relative ml-3">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex flex-col">
                        <h3 className="text-base font-semibold text-gray-600 text-base font-medium leading-none text-gray-400">
...
// export default function Header() {
//   const [userProfile, setUserProfile] = useState({});
//   const [selectedForProject, setSelectedForProject] = useState(false);
//   const navigate = useNavigate();
...
//       .then((response) => {
//         setUserProfile(response.data.userProfile);
//         checkIfSelectedForProject(userId);
//       })
//       .catch((error) => {
//         console.error("Error fetching user profile data:", error);
//       });
...
//   // const checkIfSelectedForProject = async (userId) => {
//   //   try {
//   //     const response = await axios.get(
//   //       `http://localhost:5000/posts/selected-for-project?userId=${userId}`
//   //     );
//   //     setSelectedForProject(response.data.selected);
//   //   } catch (error) {
