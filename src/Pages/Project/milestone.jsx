...
//*--------------*------------------------------------*----------*
//project compelte feature se pehele wala
// import React, { useState, useEffect } from "react";
...
//                     handleCommentChange(savedMilestone._id, e.target.value)
//                   }
//                   className="w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-indigo-500 mb-2"
//                 />
//                 <Button
//                   onClick={() => addComment(savedMilestone._id)}
...
//*--------------*------------------------------------*----------*
// abhi jo chal raha tha wo hai magar porana hai
// import React, { useState, useEffect } from "react";
// import { useParams } from "react-router-dom";
// import axios from "axios";
// import Header from "../components/header.jsx";
...
//                     Submission Links
//                   </label>
//                   {savedMilestone.submissionLinks &&
//                     savedMilestone.submissionLinks.map((link, i) => (
//                       <p key={i} className="text-gray-600 mb-2">
//                         <a
//                           href={link}
