  ...
  useEffect(() => {
    ...
    const fetchMilestones = async () => {
      try {
        ...
        setProjectStarted(response.data.length > 0); // Set project status based on milestones
      } catch (error) {
          ...
          <Tabs value={activeTab} className="m-5">
            ...
            >
              {/* <Tab
                ...
                className={
                  activeTab === "projectdetails" ? "text-gray-900" : ""
                }
              >
                Project Details
              </Tab> */}
...
//                               >
//                                 {/* <FaCopy /> */}
//                                 <Copy className="text-black hover:text-gray-500"></Copy>
//                               </button>
//                             </div>
//                           </div>
//                           <Button
