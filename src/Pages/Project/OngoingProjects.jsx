...
//           `http://localhost:5000/posts/projects-for-student?userId=${userId}`
//         );
...
//   const goToMilestones = (postId) => {
//     navigate(`/milestone/${postId}`);
//   };
...
//                   </div>
//                   <Button
//                     onClick={() => goToMilestones(project._id)}
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/posts/projects-for-student/${userIdFromCookie}`
        );
